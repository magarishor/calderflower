<?php
/**
 * calderflower functions and definitions
 *
...
if ( ! function_exists( 'calderflower_setup' ) ) :
	/**
	...
	function calderflower_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on calderflower, use a find and replace
		 * to change 'calderflower' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'calderflower', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'calderflower' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'calderflower_custom_background_args', array(
...
add_action( 'after_setup_theme', 'calderflower_setup' );
 ...
 */
function calderflower_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'calderflower_content_width', 640 );
}
add_action( 'after_setup_theme', 'calderflower_content_width', 0 );
 ...
 */
function calderflower_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'calderflower' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'calderflower' ),
...
add_action( 'widgets_init', 'calderflower_widgets_init' );
...
function calderflower_scripts() {
	...
	/*wp_enqueue_script('custom-jquery', get_template_directory_uri() . '/assets/js/custom.js' , false);*/
...
//require get_template_directory() . '/inc/metabox_functions.php';
